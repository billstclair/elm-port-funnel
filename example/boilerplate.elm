...
doing simulation. Otherwise, it's just the real `cmdPort`.
                        ...
                        Just funnel ->
                            ...
                            case funnel of
                                EchoFunnel appFunnel ->
                                    ...
                                    then
                                        -- If the `Echo` module was not
                                        -- loaded before this message came in,
                                        -- and the message changed that,
                                        -- then turn the simulator off.
                                        -- The `Startup` message happens only
                                        -- once, right after the JavaScript
                                        -- for the module is loaded.
